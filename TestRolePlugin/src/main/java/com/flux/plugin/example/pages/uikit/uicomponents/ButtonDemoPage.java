...
@PageWidgetAllow(role = { pjc.testroleplugin.AppRole.ADMIN, pjc.testroleplugin.AppRole.MANAGER, pjc.testroleplugin.AppRole.USER })
...
public class ButtonDemoPage extends TemplatePage {
    ...
    @ActionWidgetAllow(role = { pjc.testroleplugin.AppRole.ADMIN, pjc.testroleplugin.AppRole.MANAGER }, department = "")
