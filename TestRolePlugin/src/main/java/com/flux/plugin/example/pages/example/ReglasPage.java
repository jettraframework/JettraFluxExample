...
@PageWidgetAllow(role = { pjc.testroleplugin.AppRole.ADMIN, pjc.testroleplugin.AppRole.MANAGER }, department = "")
@Page(path = "/reglas")
public class ReglasPage extends TemplatePage {

    @InjectProperties(name = "messages-TestRolePlugin")
    ...
    @ActionWidgetAllow(role = { pjc.testroleplugin.AppRole.ADMIN, pjc.testroleplugin.AppRole.MANAGER })
